...
(function() {
  ...
  ({
    renderGraph: function(full_width, full_height) {
      var background, blood_conc, height, inner_wrap, margin, outer_wrap, width, x, xAxis, y, yAxis;
      margin = {
        top: 30,
        bottom: 30,
        left: 30,
      ...
      return blood_conc = d3.svg.line().x(function(d) {
        return d;
      }).y(function(d) {
        return d;
      }).interpolate("linear");
  ...
  $(document).ready(function() {
    ...
    return _this.renderGraph(full_width, full_height);
  });
